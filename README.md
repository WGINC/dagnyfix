...
2. Drop `dagnyfix`'s built `d3d8.dll` in its place.
3. Launch and play. All three fixes are active automatically — no config needed.
>>>>>>> Stashed changes
